...
public class CustomizedListView extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		Sellable group1 = new Sellable(new User("Tran","viettran@mit.edu","abc"),"6.006","$30","TEXTBOOK");
		Sellable group2 = new Sellable(new User("Duy","duyha@mit.edu","abc"),"6.005","$20","TEXTBOOK");
